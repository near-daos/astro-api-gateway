...
Common labels
*/}}
{{- define "astro-draft.labels" -}}
helm.sh/chart: {{ include "astro-draft.chart" . }}
{{ include "astro-draft.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "astro-draft.selectorLabels" -}}
app.kubernetes.io/name: {{ include "astro-draft.name" . }}
app.kubernetes.io/instance: "astro-draft"
{{- end -}}

{{/*
Create the name of the service account to use
*/}}
{{- define "astro-draft.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "astro-draft.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
