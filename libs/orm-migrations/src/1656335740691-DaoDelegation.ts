...
export class DaoDelegation1656335740691 implements MigrationInterface {
  name = 'DaoDelegation1656335740691';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "delegation" ("id" text NOT NULL, "dao_id" text NOT NULL, "account_id" character varying NOT NULL, "balance" bigint NOT NULL, "delegators" jsonb, CONSTRAINT "PK_a2cb6c9b942d68b109131beab44" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
